...
class OngkirCtrl extends Controller {
        ...
        if ($method == 'POST') {
            curl_setopt_array($curl, array(
                ...
                CURLOPT_HTTPHEADER => array(
                    ...
                    "key: d5a7e2552789aec002f4ea34bfa7c65a"
                ),
            ));
        } else {
            curl_setopt_array($curl, array(
    ...
    public function getProvince($id = null) {
        //
        $data = $this->curl_get_content('https://api.rajaongkir.com/starter/province?id=' . $id);
    ...
    public function getKota($provinceId = '') {
        $data = $this->curl_get_content('https://api.rajaongkir.com/starter/city?&province=' . $provinceId);
    ...
    public function getCity($cityId = '', $provinceId = '') {
        $data = $this->curl_get_content('https://api.rajaongkir.com/starter/city?id=' . $cityId . '&province=' . $provinceId);
        $city = json_decode($data, true);
        if($cityId != ''){
